...
public class ListSource<T extends Event> implements Source<T> {
    private final List<T> delegate;
    private final OptionalInt intendedSize;

    ListSource(List<T> delegate, OptionalInt intendedSize) {
    ...
    public Optional<T> getLatest() {
        ...
        return Optional.of(delegate.get(delegate.size() - 1));
    }
